...
const dashboardLayoutAtom = atomWithStorage<Layout>('dashboard-layout', [
  ...
  { i: 'avg-salary-by-dept', x: 6, y: 13, w: 6, h: 10, isResizable: false },
  { i: 'empl-count-by-job-grade', x: 0, y: 16, w: 6, h: 10, isResizable: false },
  { i: 'activity-stats', x: 6, y: 23, w: 6, h: 10, isResizable: false },
  // Dividers
  { i: 'divider-1', x: 0, y: 33, w: 12, h: 2 },
  { i: 'divider-2', x: 0, y: 33, w: 12, h: 2 }
]);
